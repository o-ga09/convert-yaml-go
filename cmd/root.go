...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.convertyaml.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".convertyaml" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".convertyaml")
	}
